<nav class="sidebar sidebar-offcanvas sticky-top" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        ...
        <a class="sidebar-brand brand-logo-mini" href="index.php">K</a>
    </div>
    <ul class="nav">
        <li class="nav-item profile">
            <div class="profile-desc">
                ...
                <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list"
                    ...
                    <a href="admin_profile.php" class="dropdown-item preview-item">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="view_message.php">
                <span class="menu-icon">
                    <i class="mdi mdi-basket-fill"></i>
                </span>
                <span class="menu-title">Content Us </span>
            </a>
        </li>
